 ...
 */
public final class CallExpressionForSuperConstructorGenerator extends BaseAstProcessor<Swc4jAstCallExpr> {
    public CallExpressionForSuperConstructorGenerator(ByteCodeCompiler compiler) {
        super(compiler);
    }

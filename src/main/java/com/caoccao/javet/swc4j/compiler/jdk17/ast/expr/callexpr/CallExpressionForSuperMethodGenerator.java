 ...
 */
public final class CallExpressionForSuperMethodGenerator extends BaseAstProcessor<Swc4jAstCallExpr> {
    public CallExpressionForSuperMethodGenerator(ByteCodeCompiler compiler) {
        super(compiler);
    }

...
public final class CallExpressionForArrayStaticGenerator extends BaseAstProcessor<Swc4jAstCallExpr> {
    public CallExpressionForArrayStaticGenerator(ByteCodeCompiler compiler) {
        super(compiler);
    }

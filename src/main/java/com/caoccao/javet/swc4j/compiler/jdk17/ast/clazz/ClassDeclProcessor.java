...
/**
 * Processes class declarations by delegating to the ClassProcessor.
 */
public final class ClassDeclProcessor extends BaseAstProcessor<Swc4jAstClassDecl> {
     ...
     */
    public ClassDeclProcessor(ByteCodeCompiler compiler) {
        super(compiler);
    }
    ...
    public void generate(CodeBuilder code, ClassWriter classWriter, Swc4jAstClassDecl classDecl, ReturnTypeInfo returnTypeInfo) throws Swc4jByteCodeCompilerException {
        compiler.getClassProcessor().generate(code, classWriter, classDecl.getClazz(), returnTypeInfo);
    }
}

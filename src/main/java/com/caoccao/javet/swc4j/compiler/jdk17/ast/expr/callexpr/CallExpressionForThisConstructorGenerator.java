 ...
 */
public final class CallExpressionForThisConstructorGenerator extends BaseAstProcessor<Swc4jAstCallExpr> {
    public CallExpressionForThisConstructorGenerator(ByteCodeCompiler compiler) {
        super(compiler);
    }

...
public final class ConditionalExpressionProcessor extends BaseAstProcessor<Swc4jAstCondExpr> {
    ...
    public void generate(
        ...
        compiler.getExpressionProcessor().generate(code, classWriter, condExpr.getTest(), null);
        ...
        compiler.getExpressionProcessor().generate(code, classWriter, condExpr.getCons(), null);
        ...
        compiler.getExpressionProcessor().generate(code, classWriter, condExpr.getAlt(), null);
        // Convert to common type if needed

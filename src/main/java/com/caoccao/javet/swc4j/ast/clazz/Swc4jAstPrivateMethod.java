...
/**
 * The type swc4j ast private method.
 */
...
public class Swc4jAstPrivateMethod
    ...
    /**
     * Instantiates a new swc4j ast private method.
     *
     * @param key           the key
    ...
    /**
     * Create swc4j ast private method.
     *
     * @param key      the key
     * @param function the function
     * @param kind     the kind
     * @return the swc4j ast private method
     */
    ...
    public boolean replaceNode(ISwc4jAst oldNode, ISwc4jAst newNode) {
        ...
        if (key == oldNode && newNode instanceof Swc4jAstPrivateName newKey) {
            setKey(newKey);
            return true;
        }
        return false;
    ...
    public Swc4jAstVisitorResponse visit(ISwc4jAstVisitor visitor) {
        return switch (visitor.visitPrivateMethod(this)) {

...
/**
 * The type swc4j ast ts non null expr.
 */
...
public class Swc4jAstTsNonNullExpr
    ...
    /**
     * Instantiates a new swc4j ast ts non null expr.
     *
     * @param expr the expr
     * @param span the span
     */
    ...
    /**
     * Create swc4j ast ts non null expr.
     *
     * @param expr the expr
     * @return the swc4j ast ts non null expr
     */

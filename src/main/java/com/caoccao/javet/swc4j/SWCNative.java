...
final class SWCNative {
    public static final String LIB_NAME = "swc4j";
    ...
    private static void deployLibFile(String resourceFileName, File libFile) {
    ...
    private static void purge(File rootLibPath) {
        try {
            if (rootLibPath.exists()) {

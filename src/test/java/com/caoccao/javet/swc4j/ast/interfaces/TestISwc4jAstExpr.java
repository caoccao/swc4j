...
public class TestISwc4jAstExpr {
    ...
    public void testAssignable() {
        ...
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstBinExpr.class));
        ...
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstJsxFragment.class));
        ...
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstTsAsExpr.class));
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstTsConstAssertion.class));
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstTsInstantiation.class));
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstTsNonNullExpr.class));
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstTsSatisfiesExpr.class));
        assertTrue(ISwc4jAstExpr.class.isAssignableFrom(Swc4jAstTsTypeAssertion.class));

...
public class TestCompileBinExprRShift extends BaseTestCompileSuite {
    ...
    public void testByteRightShiftInt(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((int) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(7); // 56 >> 3 = 7
    }
    ...
    public void testDivideByPowerOf2(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((int) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(1); // 1024 >> 10 = 1
    }
    ...
    public void testIntRightShiftBy31(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((int) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(-1); // Any negative >> 31 = -1
    }
    ...
    public void testLongDivideByPowerOf2(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((long) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(1L); // 1099511627776 >> 40 = 1
    }
    ...
    public void testLongRightShiftBy63(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((long) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(-1L); // Any negative >> 63 = -1
    }
    ...
    public void testNegativeIntRightShift(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((int) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(-5); //-20 >> 2 = -5 (sign extended)
    }
    ...
    public void testNegativeLongRightShift(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((long) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(-100L); //-800 >> 3 = -100 (sign extended)
    }
    ...
    public void testPositiveIntRightShiftBy31(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((int) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(0); // Integer.MAX_VALUE >> 31 = 0
    }
    ...
    public void testPositiveLongRightShiftBy63(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat((long) runner.createInstanceRunner("com.A").invoke("test")).isEqualTo(0L); // Any positive small value >> 63 = 0
    }

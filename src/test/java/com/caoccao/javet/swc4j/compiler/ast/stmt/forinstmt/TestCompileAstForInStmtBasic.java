...
public class TestCompileAstForInStmtBasic extends BaseTestCompileSuite {
    ...
    public void testBasicArrayGetByIndex(JdkVersion jdkVersion) throws Exception {
    ...
    public void testBasicArrayIteration(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat(runner.createInstanceRunner("com.A").<Object>invoke("test")).isEqualTo("012");
    }
    ...
    public void testLabeledBreak(JdkVersion jdkVersion) throws Exception {
        ...
        assertThat(runner.createInstanceRunner("com.A").<Object>invoke("test")).isEqualTo("ax,ay,");
    }

...
pub mod program {
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_array_lit(env, &java_elems, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_array_pat(env, &java_elems, optional, &java_optional_type_ann, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_arrow_expr(env, &java_params, &java_body, is_async, is_generator, &java_optional_type_params, &java_optional_return_type, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_assign_expr(env, op, &java_left, &java_right, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_right = enum_create_expr(env, map, &node.right);
    let return_value = java_ast_factory.create_assign_pat(env, &java_left, &java_right, &java_span_ex);
    delete_local_ref!(env, java_left);
    delete_local_ref!(env, java_right);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_assign_pat_prop(env, &java_key, &java_optional_value, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_assign_prop(env, &java_key, &java_value, &java_span_ex);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_value);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let optional_accessibility = node.accessibility.as_ref().map_or(-1, |node| node.get_id());
    let is_override = node.is_override;
    let definite = node.definite;
    let return_value = java_ast_factory.create_auto_accessor(env, &java_key, &java_optional_value, &java_optional_type_ann, is_static, &java_decorators, optional_accessibility, is_override, definite, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_value);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_ref!(env, java_key);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_await_expr(env, &java_arg, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_right = enum_create_expr(env, map, &node.right);
    let return_value = java_ast_factory.create_bin_expr(env, op, &java_left, &java_right, &java_span_ex);
    delete_local_ref!(env, java_left);
    delete_local_ref!(env, java_right);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_call_expr(env, &java_callee, &java_args, &java_optional_type_args, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_catch_clause(env, &java_optional_param, &java_body, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_class(env, &java_decorators, &java_body, &java_optional_super_class, is_abstract, &java_optional_type_params, &java_optional_super_type_params, &java_implements, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_class = create_class(env, map, &node.class);
    let return_value = java_ast_factory.create_class_expr(env, &java_optional_ident, &java_class, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let is_override = node.is_override;
    let return_value = java_ast_factory.create_class_method(env, &java_key, &java_function, kind, is_static, optional_accessibility, is_abstract, is_optional, is_override, &java_span_ex);
    delete_local_ref!(env, java_key);
    ...
    'local: 'a,
  {
    ...
    let declare = node.declare;
    let definite = node.definite;
    let return_value = java_ast_factory.create_class_prop(env, &java_key, &java_optional_value, &java_optional_type_ann, is_static, &java_decorators, optional_accessibility, is_abstract, is_optional, is_override, readonly, declare, definite, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_value);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_decorators);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_computed_prop_name(env, &java_expr, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_cond_expr(env, &java_test, &java_cons, &java_alt, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let optional_accessibility = node.accessibility.as_ref().map_or(-1, |node| node.get_id());
    let is_optional = node.is_optional;
    let return_value = java_ast_factory.create_constructor(env, &java_key, &java_params, &java_optional_body, optional_accessibility, is_optional, &java_span_ex);
    ...
    'local: 'a,
  {
    let java_ast_factory = unsafe { JAVA_AST_FACTORY.as_ref().unwrap() };
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let return_value = java_ast_factory.create_debugger_stmt(env, &java_span_ex);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let java_expr = enum_create_expr(env, map, &node.expr);
    let return_value = java_ast_factory.create_decorator(env, &java_expr, &java_span_ex);
    delete_local_ref!(env, java_expr);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_do_while_stmt(env, &java_test, &java_body, &java_span_ex);
    delete_local_ref!(env, java_test);
    delete_local_ref!(env, java_body);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    let java_ast_factory = unsafe { JAVA_AST_FACTORY.as_ref().unwrap() };
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let return_value = java_ast_factory.create_empty_stmt(env, &java_span_ex);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_export_all(env, &java_src, type_only, &java_optional_with, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_export_named_specifier(env, &java_orig, &java_optional_exported, is_type_only, &java_span_ex);
    ...
    'local: 'a,
  {
    let java_ast_factory = unsafe { JAVA_AST_FACTORY.as_ref().unwrap() };
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span()));
    let java_optional_spread = node.spread.as_ref().map(|node| java_ast_factory.create_span(env, &map.get_span_ex_by_span(node)));
    let java_expr = enum_create_expr(env, map, &node.expr);
    ...
    'local: 'a,
  {
    ...
    let java_optional_ident = node.ident.as_ref().map(|node| create_ident(env, map, node));
    let java_function = create_function(env, map, &node.function);
    let return_value = java_ast_factory.create_fn_expr(env, &java_optional_ident, &java_function, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_ident);
    delete_local_ref!(env, java_function);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let java_right = enum_create_expr(env, map, &node.right);
    let java_body = enum_create_stmt(env, map, &node.body);
    let return_value = java_ast_factory.create_for_of_stmt(env, is_await, &java_left, &java_right, &java_body, &java_span_ex);
    delete_local_ref!(env, java_left);
    delete_local_ref!(env, java_right);
    delete_local_ref!(env, java_body);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_body = enum_create_stmt(env, map, &node.body);
    let return_value = java_ast_factory.create_for_stmt(env, &java_optional_init, &java_optional_test, &java_optional_update, &java_body, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_decl(env, map, node));
    let java_optional_return_type = node.return_type.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let return_value = java_ast_factory.create_function(env, &java_params, &java_decorators, &java_optional_body, is_generator, is_async, &java_optional_type_params, &java_optional_return_type, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_body);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_optional_ref!(env, java_optional_return_type);
    delete_local_ref!(env, java_params);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let java_optional_body = node.body.as_ref().map(|node| create_block_stmt(env, map, node));
    let return_value = java_ast_factory.create_getter_prop(env, &java_key, &java_optional_type_ann, &java_optional_body, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_optional_ref!(env, java_optional_body);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_import(env, phase, &java_span_ex);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let java_optional_with = node.with.as_ref().map(|node| create_object_lit(env, map, node));
    let phase = node.phase.get_id();
    let return_value = java_ast_factory.create_import_decl(env, &java_specifiers, &java_src, type_only, &java_optional_with, phase, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_with);
    ...
    'local: 'a,
  {
    ...
    let is_type_only = node.is_type_only;
    let return_value = java_ast_factory.create_import_named_specifier(env, &java_local, &java_optional_imported, is_type_only, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_jsx_element(env, &java_opening, &java_children, &java_optional_closing, &java_span_ex);
    ...
    'local: 'a,
  {
    let java_ast_factory = unsafe { JAVA_AST_FACTORY.as_ref().unwrap() };
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let return_value = java_ast_factory.create_jsx_empty_expr(env, &java_span_ex);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_jsx_expr_container(env, &java_expr, &java_span_ex);
    delete_local_ref!(env, java_expr);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_jsx_fragment(env, &java_opening, &java_children, &java_closing, &java_span_ex);
    delete_local_ref!(env, java_opening);
    delete_local_ref!(env, java_children);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_jsx_member_expr(env, &java_obj, &java_prop, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_jsx_namespaced_name(env, &java_ns, &java_name, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_args = node.type_args.as_ref().map(|node| create_ts_type_param_instantiation(env, map, node));
    let return_value = java_ast_factory.create_jsx_opening_element(env, &java_name, &java_attrs, self_closing, &java_optional_type_args, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_args);
    delete_local_ref!(env, java_name);
    ...
    'local: 'a,
  {
    ...
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let java_expr = enum_create_expr(env, map, &node.expr);
    let return_value = java_ast_factory.create_jsx_spread_child(env, &java_expr, &java_span_ex);
    delete_local_ref!(env, java_expr);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_key_value_pat_prop(env, &java_key, &java_value, &java_span_ex);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_value);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let java_key = enum_create_prop_name(env, map, &node.key);
    let java_value = enum_create_expr(env, map, &node.value);
    let return_value = java_ast_factory.create_key_value_prop(env, &java_key, &java_value, &java_span_ex);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_value);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_member_expr(env, &java_obj, &java_prop, &java_span_ex);
    delete_local_ref!(env, java_obj);
    delete_local_ref!(env, java_prop);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let kind = node.kind.get_id();
    let return_value = java_ast_factory.create_meta_prop_expr(env, kind, &java_span_ex);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let java_key = enum_create_prop_name(env, map, &node.key);
    let java_function = create_function(env, map, &node.function);
    let return_value = java_ast_factory.create_method_prop(env, &java_key, &java_function, &java_span_ex);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_function);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let type_only = node.type_only;
    let java_optional_with = node.with.as_ref().map(|node| create_object_lit(env, map, node));
    let return_value = java_ast_factory.create_named_export(env, &java_specifiers, &java_optional_src, type_only, &java_optional_with, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_args = node.type_args.as_ref().map(|node| create_ts_type_param_instantiation(env, map, node));
    let return_value = java_ast_factory.create_new_expr(env, &java_callee, &java_optional_args, &java_optional_type_args, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let optional = node.optional;
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let return_value = java_ast_factory.create_object_pat(env, &java_props, optional, &java_optional_type_ann, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_ref!(env, java_props);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_args = node.type_args.as_ref().map(|node| create_ts_type_param_instantiation(env, map, node));
    let return_value = java_ast_factory.create_opt_call(env, &java_callee, &java_args, &java_optional_type_args, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_args);
    delete_local_ref!(env, java_callee);
    delete_local_ref!(env, java_args);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_param(env, &java_decorators, &java_pat, &java_span_ex);
    delete_local_ref!(env, java_decorators);
    ...
    'local: 'a,
  {
    ...
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let java_expr = enum_create_expr(env, map, &node.expr);
    let return_value = java_ast_factory.create_paren_expr(env, &java_expr, &java_span_ex);
    delete_local_ref!(env, java_expr);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let is_optional = node.is_optional;
    let is_override = node.is_override;
    let return_value = java_ast_factory.create_private_method(env, &java_key, &java_function, kind, is_static, optional_accessibility, is_abstract, is_optional, is_override, &java_span_ex);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_function);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let java_id = create_ident(env, map, &node.id);
    let return_value = java_ast_factory.create_private_name(env, &java_id, &java_span_ex);
    delete_local_ref!(env, java_id);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let readonly = node.readonly;
    let definite = node.definite;
    let return_value = java_ast_factory.create_private_prop(env, &java_key, &java_optional_value, &java_optional_type_ann, is_static, &java_decorators, optional_accessibility, is_optional, is_override, readonly, definite, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_value);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_decorators);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let return_value = java_ast_factory.create_rest_pat(env, &java_dot3_token, &java_arg, &java_optional_type_ann, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_seq_expr(env, &java_exprs, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_body = node.body.as_ref().map(|node| create_block_stmt(env, map, node));
    let return_value = java_ast_factory.create_setter_prop(env, &java_key, &java_optional_this_param, &java_param, &java_optional_body, &java_span_ex);
    ...
    'local: 'a,
  {
    let java_ast_factory = unsafe { JAVA_AST_FACTORY.as_ref().unwrap() };
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let return_value = java_ast_factory.create_super(env, &java_span_ex);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_super_prop_expr(env, &java_obj, &java_prop, &java_span_ex);
    delete_local_ref!(env, java_obj);
    delete_local_ref!(env, java_prop);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_tagged_tpl(env, &java_tag, &java_optional_type_params, &java_tpl, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_params);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_try_stmt(env, &java_block, &java_optional_handler, &java_optional_finalizer, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_decl(env, map, node));
    let return_value = java_ast_factory.create_ts_call_signature_decl(env, &java_params, &java_optional_type_ann, &java_optional_type_params, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_params);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_conditional_type(env, &java_check_type, &java_extends_type, &java_true_type, &java_false_type, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_decl(env, map, node));
    let return_value = java_ast_factory.create_ts_construct_signature_decl(env, &java_params, &java_optional_type_ann, &java_optional_type_params, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_params);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let is_abstract = node.is_abstract;
    let return_value = java_ast_factory.create_ts_constructor_type(env, &java_params, &java_optional_type_params, &java_type_ann, is_abstract, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_params);
    delete_local_ref!(env, java_type_ann);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_enum_decl(env, declare, is_const, &java_id, &java_members, &java_span_ex);
    delete_local_ref!(env, java_id);
    ...
    'local: 'a,
  {
    ...
    let java_expr = enum_create_expr(env, map, &node.expr);
    let java_optional_type_args = node.type_args.as_ref().map(|node| create_ts_type_param_instantiation(env, map, node));
    let return_value = java_ast_factory.create_ts_expr_with_type_args(env, &java_expr, &java_optional_type_args, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_args);
    delete_local_ref!(env, java_expr);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_decl(env, map, node));
    let java_type_ann = create_ts_type_ann(env, map, &node.type_ann);
    let return_value = java_ast_factory.create_ts_fn_type(env, &java_params, &java_optional_type_params, &java_type_ann, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_params);
    delete_local_ref!(env, java_type_ann);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let optional = node.optional;
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let return_value = java_ast_factory.create_ts_getter_signature(env, readonly, &java_key, computed, optional, &java_optional_type_ann, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_import_equals_decl(env, is_export, is_type_only, &java_id, &java_module_ref, &java_span_ex);
    delete_local_ref!(env, java_id);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_args = node.type_args.as_ref().map(|node| create_ts_type_param_instantiation(env, map, node));
    let return_value = java_ast_factory.create_ts_import_type(env, &java_arg, &java_optional_qualifier, &java_optional_type_args, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let readonly = node.readonly;
    let is_static = node.is_static;
    let return_value = java_ast_factory.create_ts_index_signature(env, &java_params, &java_optional_type_ann, readonly, is_static, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_ref!(env, java_params);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_indexed_access_type(env, readonly, &java_obj_type, &java_index_type, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_instantiation(env, &java_expr, &java_type_args, &java_span_ex);
    delete_local_ref!(env, java_expr);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_interface_body(env, &java_body, &java_span_ex);
    delete_local_ref!(env, java_body);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_interface_decl(env, &java_id, declare, &java_optional_type_params, &java_extends, &java_body, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_id);
    ...
    'local: 'a,
  {
    let java_ast_factory = unsafe { JAVA_AST_FACTORY.as_ref().unwrap() };
    let java_span_ex = java_ast_factory.create_span(env, &map.get_span_ex_by_span(&node.span));
    let optional_readonly = node.readonly.as_ref().map_or(-1, |node| node.get_id());
    let java_type_param = create_ts_type_param(env, map, &node.type_param);
    let java_optional_name_type = node.name_type.as_ref().map(|node| enum_create_ts_type(env, map, node));
    let optional_optional = node.optional.as_ref().map_or(-1, |node| node.get_id());
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| enum_create_ts_type(env, map, node));
    let return_value = java_ast_factory.create_ts_mapped_type(env, optional_readonly, &java_type_param, &java_optional_name_type, optional_optional, &java_optional_type_ann, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_decl(env, map, node));
    let return_value = java_ast_factory.create_ts_method_signature(env, readonly, &java_key, computed, optional, &java_params, &java_optional_type_ann, &java_optional_type_params, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_params);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_module_block(env, &java_body, &java_span_ex);
    delete_local_ref!(env, java_body);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_module_decl(env, declare, global, &java_id, &java_optional_body, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_body);
    delete_local_ref!(env, java_id);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_namespace_decl(env, declare, global, &java_id, &java_body, &java_span_ex);
    delete_local_ref!(env, java_id);
    delete_local_ref!(env, java_body);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_param_prop(env, &java_decorators, optional_accessibility, is_override, readonly, &java_param, &java_span_ex);
    delete_local_ref!(env, java_decorators);
    delete_local_ref!(env, java_param);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_decl(env, map, node));
    let return_value = java_ast_factory.create_ts_property_signature(env, readonly, &java_key, computed, optional, &java_optional_init, &java_params, &java_optional_type_ann, &java_optional_type_params, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_init);
    delete_local_optional_ref!(env, java_optional_type_ann);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_key);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_setter_signature(env, readonly, &java_key, computed, optional, &java_param, &java_span_ex);
    delete_local_ref!(env, java_key);
    delete_local_ref!(env, java_param);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_tuple_element(env, &java_optional_label, &java_ty, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_label);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_decl(env, map, node));
    let java_type_ann = enum_create_ts_type(env, map, &node.type_ann);
    let return_value = java_ast_factory.create_ts_type_alias_decl(env, &java_id, declare, &java_optional_type_params, &java_type_ann, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_params);
    delete_local_ref!(env, java_id);
    delete_local_ref!(env, java_type_ann);
    delete_local_ref!(env, java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_ts_type_param(env, &java_name, is_in, is_out, is_const, &java_optional_constraint, &java_optional_default, &java_span_ex);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_ann = node.type_ann.as_ref().map(|node| create_ts_type_ann(env, map, node));
    let return_value = java_ast_factory.create_ts_type_predicate(env, asserts, &java_param_name, &java_optional_type_ann, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_ann);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_args = node.type_args.as_ref().map(|node| create_ts_type_param_instantiation(env, map, node));
    let return_value = java_ast_factory.create_ts_type_query(env, &java_expr_name, &java_optional_type_args, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_args);
    ...
    'local: 'a,
  {
    ...
    let java_optional_type_params = node.type_params.as_ref().map(|node| create_ts_type_param_instantiation(env, map, node));
    let return_value = java_ast_factory.create_ts_type_ref(env, &java_type_name, &java_optional_type_params, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_type_params);
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_var_decl(env, kind, declare, &java_decls, &java_span_ex);
    delete_local_ref!(env, java_decls);
    delete_local_ref!(env, java_span_ex);
    return_value
  }
    ...
    'local: 'a,
  {
    ...
    let java_optional_init = node.init.as_ref().map(|node| enum_create_expr(env, map, node));
    let definite = node.definite;
    let return_value = java_ast_factory.create_var_declarator(env, &java_name, &java_optional_init, definite, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_init);
    delete_local_ref!(env, java_name);
    delete_local_ref!(env, java_span_ex);
    return_value
    ...
    'local: 'a,
  {
    ...
    let return_value = java_ast_factory.create_yield_expr(env, &java_optional_arg, delegate, &java_span_ex);
    delete_local_optional_ref!(env, java_optional_arg);
    delete_local_ref!(env, java_span_ex);
    return_value
  }

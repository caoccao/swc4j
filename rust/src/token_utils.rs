  ...
  pub fn new<'local>(env: &mut JNIEnv<'local>) -> Self {
    ...
    let method_create_assign_operator = env
      .get_static_method_id(
        ...
        "(ILcom/caoccao/javet/swc4j/utils/Swc4jSpan;Z)Lcom/caoccao/javet/swc4j/tokens/Swc4jToken;",
      )
    ...
    let method_create_big_int = env
      .get_static_method_id(
        &class,
        "createBigInt",
        "(Ljava/lang/String;Lcom/caoccao/javet/swc4j/utils/Swc4jSpan;Z)Lcom/caoccao/javet/swc4j/tokens/Swc4jTokenTextValue;",
      )
    ...
    let method_create_error = env
      .get_static_method_id(
        &class,
        "createError",
        "(Ljava/lang/String;Ljava/lang/String;Lcom/caoccao/javet/swc4j/utils/Swc4jSpan;Z)Lcom/caoccao/javet/swc4j/tokens/Swc4jTokenTextValue;",
      )
    ...
    let method_create_false = env
      .get_static_method_id(
        &class,
        "createFalse",
        "(Lcom/caoccao/javet/swc4j/utils/Swc4jSpan;Z)Lcom/caoccao/javet/swc4j/tokens/Swc4jToken;",
      )
    ...
    let method_create_ident_known = env
      .get_static_method_id(
        &class,
        "createIdentKnown",
        "(Ljava/lang/String;Lcom/caoccao/javet/swc4j/utils/Swc4jSpan;Z)Lcom/caoccao/javet/swc4j/tokens/Swc4jTokenText;",
      )
    ...
    let method_create_number = env
      .get_static_method_id(
        &class,
        "createNumber",
        "(Ljava/lang/String;DLcom/caoccao/javet/swc4j/utils/Swc4jSpan;Z)Lcom/caoccao/javet/swc4j/tokens/Swc4jTokenTextValue;",
      )
    ...
    let method_create_regex = env
      .get_static_method_id(
        &class,
        "createRegex",
        "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/caoccao/javet/swc4j/utils/Swc4jSpan;Z)Lcom/caoccao/javet/swc4j/tokens/Swc4jTokenTextValueFlags;",
      )
      ...
      Some(token_and_spans) => {
        ...
        token_and_spans.iter().for_each(|token_and_span| {
          ...
          let java_token = match &token_and_span.token {
            ...
            Token::JSXText { raw } => {
              java_token_factory.create_jsx_tag_text(env, &raw, &java_span_ex, line_break_ahead)
            }
